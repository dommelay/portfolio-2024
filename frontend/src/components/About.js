        ...
        <div id='testcontainer'>
            ...
            <div id='aboutcontainer'>
                ...
                <div id='integritybox'>
                    ...
                    <h2 className='normaltext aboutdescription'>As an autistic person, I take pride in my sense of integrity and high regard as it is often misunderstood as rigidity. I believe in exploring cognitive dissonance and disengaging confirmation bias as the most virtuous way to remain consistent in one's principles. In my professional and personal endeavors, I strive to foster environments centered around open communication, transparency, and collaboration. My motivation to work hard stems directly from my commitment to only perform fair and honest work. 
</h2>
                </div>
            </div>
